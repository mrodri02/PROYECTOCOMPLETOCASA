...
Abre PROYECTOCOMPLETOCASA.ino en Arduino IDE.
En el IDE selecciona la placa correcta (p. ej. "ESP32 Dev Module") y el puerto COM correspondiente.
Instala la librería IRremote si no está instalada:
En Arduino IDE: Programa → Incluir Librería → Administrar Bibliotecas… → buscar "IRremote" e instalar.
Compila y sube el sketch a la placa.
Abre el Monitor Serie (115200 baudios) para ver mensajes de estado cuando pulses los botones del mando.
Uso
